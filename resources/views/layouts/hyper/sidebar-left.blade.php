<div class="leftside-menu">
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <!-- Submenu -->
            @if (view()->exists('jinyauth::admin.sidebar-hyper'))
                @include('jinyauth::admin.sidebar-hyper')
            @endif

            <!-- Submenu -->
            @if (view()->exists('modules::admin.menu'))
                @include('modules::admin.menu')
            @endif

            <!-- Submenu -->
            @if (view()->exists('jinytheme::admin.menu'))
                @include('jinytheme::admin.menu')
            @endif
            ...
            <!-- Help Box -->
            @include("jiny-admin::layouts.hyper.cta")
            <!-- end Help Box -->
