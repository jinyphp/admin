<ul role="list" class="-mx-2 space-y-1">
    ...
    <li>
        <a href="{{ route('admin.security.ip-whitelist', ['prefix'=>request()->route('prefix') ?? 'admin']) }}" 
    ...
    <li>
        <a href="{{ route('admin.ipblacklist', ['prefix'=>request()->route('prefix') ?? 'admin']) }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.ipblacklist*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
    ...
    <li>
        <a href="{{ route('admin.iptracking', ['prefix'=>request()->route('prefix') ?? 'admin']) }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.iptracking*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
    ...
    <li>
        <a href="{{ route('admin.captcha.logs', ['prefix'=>request()->route('prefix') ?? 'admin']) }}" 
    ...
    <li>
        <a href="{{ route('admin.user.logs', ['prefix'=>request()->route('prefix') ?? 'admin']) }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.user.logs*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
    ...
    <li>
        <a href="{{ route('admin.user.password.logs', ['prefix'=>request()->route('prefix') ?? 'admin']) }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.user.password.logs*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
    ...
    <li>
        <a href="{{ route('admin.user.sessions', ['prefix'=>request()->route('prefix') ?? 'admin']) }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.user.sessions*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
    ...
    <li>
        <a href="{{ route('admin.user.2fa', ['prefix'=>request()->route('prefix') ?? 'admin']) }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.user.2fa*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
    ...
    <li>
        <a href="{{ route('admin.mail') }}" 
           class="text-xs/6 font-semibold {{ request()->routeIs('admin.mail*') ? 'text-white' : 'text-gray-400 hover:text-gray-300' }} mt-4 block">
            메일 관리
        </a>
    </li>
    <li>
        <a href="{{ route('admin.mail') }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.mail') && !request()->routeIs('admin.mail.*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
    ...
    <li>
        <a href="{{ route('admin.mail.templates') }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.mail.templates*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
    ...
    <li>
        <a href="{{ route('admin.mail.logs') }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.mail.logs*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
                <path d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            발송 기록
    ...
    <li>
        <a href="{{ route('admin.mail.setting') }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.mail.setting*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
    ...
    <li>
        <a href="{{ route('admin.sms.provider', ['prefix'=>request()->route('prefix') ?? 'admin']) }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.sms.provider*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
    ...
    <li>
        <a href="{{ route('admin.sms.send', ['prefix'=>request()->route('prefix') ?? 'admin']) }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.sms.send*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
    ...
    <li>
        <a href="{{ route('admin.notifications', ['prefix'=>request()->route('prefix') ?? 'admin']) }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.notifications*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
    ...
    <li>
        <a href="{{ route('admin.user.type', ['prefix'=>request()->route('prefix') ?? 'admin']) }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.user.type*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
    ...
    <li>
        <a href="{{ route('admin.avatar', ['prefix'=>request()->route('prefix') ?? 'admin']) }}" 
           class="group flex gap-x-3 rounded-md {{ request()->routeIs('admin.avatar*') ? 'bg-white/5 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5' }} p-2 text-sm/6 font-semibold">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 shrink-0">
