...
/**
 * Emailtracking 관리 메인 컨트롤러 (목록/인덱스 페이지)
 *
 * Emailtracking 목록을 표시하고 관리하는 기능을 제공합니다.
 * Livewire 컴포넌트(AdminTable)와 Hook 패턴을 통해 동작합니다.
 *
 * @package Jiny\Admin\App\Http\Controllers\Admin\AdminEmailtracking
 * @since   1.0.0
 */
class AdminEmailtracking extends Controller
{
    /**
     * JSON 설정 데이터
     *
     ...
     * 컨트롤러 생성자
     *
     * AdminEmailtracking.json 설정 파일을 로드하여 컨트롤러를 초기화합니다.
     */
    ...
    public function hookSearch($wire)
    {
        return $this->jsonData['index']['search'] ?? [
            'placeholder' => 'Search emailtrackings...',
            'debounce' => 300
        ];
    }
