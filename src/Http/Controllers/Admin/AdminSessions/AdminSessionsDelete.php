...
/**
 * AdminSessionsDelete Controller
 */
class AdminSessionsDelete extends Controller
{
    private $jsonData;
    ...
    {
        // 데이터베이스에서 데이터 조회
        $tableName = $this->jsonData['table']['name'] ?? 'admin_sessions';
        ...
        $viewPath = $this->jsonData['template']['delete'] ??
                    'jiny-admin::admin.admin_sessions.delete';
    ...
    private function logDeletion($data)
    {
        ...
        Log::channel($channel)->$level('Sessions deleted', $logData);
    }
